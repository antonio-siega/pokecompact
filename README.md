# Pokécompact
PHP website that provides compact data about pokémon (limited to sprite, type, stats and learnable moves). Made as a study on API consumption, PHP, Bootstrap and caching. This project helped me learn:
* Basic file operations using PHP;
* Notions of data caching using local storage methods (JSON files);
